#!/bin/bash
#SBATCH --job-name=mlm_finance_only
...
echo "✅ All data files found. Starting MLM training with finance only..."

# 运行训练（仅金融）
echo "Running MLM training with finance data only..."
...
if [ $? -eq 0 ]; then
    ...
    echo "End Time: $(date)"
    echo "Output directory: outputs/mlm_bert_goemotions_finance/"
    echo "=========================================="
